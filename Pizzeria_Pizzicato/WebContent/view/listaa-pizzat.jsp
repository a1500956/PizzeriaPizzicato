...
<body>
	...
	<div class="button">
		<a href="pizzaMenu">Palaa etusivulle</a>
	</div>
	<table class="listaa-pizzat" width="auto" border="1" align="center">
		...
		<tr>
			...
			<td><div class="toiminnot">
					<a href="muokkaa-pizza?id=<%=pizzat.get(i).getId()%>"
						class="button"> Muokkaa </a> <a
						href="poista-pizza?id=<%=pizzat.get(i).getId()%>&id2=<%=pizzat.get(i).getNimi()%>"
						class="button"> Poista </a>
				</div></td>
		</tr>
		<% } %>
	</table>
