...
@WebServlet("/listaaTilauksettarjoilija")
public class listaaTilauksettarjoilija extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public listaaTilauksettarjoilija() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String jsp = "/view/listaa-tarjoilija.jsp"; 
...
try {
			...
			response.sendRedirect("listaaTilauksettarjoilija");
